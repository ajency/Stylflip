...
<tr>
    <td colspan="3"><a href="addBrand.php">Add Brand</a></div></td>  
</tr>
<?php
	if ($total_rows > 0) {
?>
<tr>
    <td colspan="3"><div align="right"><strong>Page  - </strong> <?php echo $pager->renderNav('<span>', '</span>'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>  
</tr>	
<?php		
	}
?>	
...
?>
<tr>
    <td colspan="3"><div align="center">No Brands Found.</div></td>  
</tr>
<?php
}
else {
...
<tr>
	...
	<td><?php echo $name; ?></td>
	<td align="center">
		<a href="editBrand.php?Id=<?php echo $id; ?>">Edit</a> | 
		<a href="#" onclick="deleteUser('<?php echo $baseURL ?>api/brand.php?action=delete&Id=<?php echo $id; ?>');">Delete</a>
	</td>
<?php	
		$sr=$sr+1;
	}
